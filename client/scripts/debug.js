...
(async () => {
    ...
    await asyncProcess(`yarn yarn webpack-cli serve --config ./config/webpack.dev.js --mode development --host 0.0.0.0 --port ${devPort} --public ${parsedBackendUrl.hostname}`, {
        shell: true,
        cwd: join(__dirname, '..'),
        ignoreErrors: true,
    })[0];
